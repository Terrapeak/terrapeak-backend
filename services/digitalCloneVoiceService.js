...
const PROVIDER_ERROR_RESPONSES = Object.freeze({
  ...
  VOICE_PROVIDER_PLAN_REQUIRED: ["TerraPeak Voice is not enabled for this account.", 403],
  ...
  VOICE_PROVIDER_INVALID_REQUEST: ["TerraPeak Voice could not accept the request.", 400],
