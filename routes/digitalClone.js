...
import { digitalCloneAvatarDiscoveryRateLimit, digitalCloneAvatarGenerationRateLimit, digitalCloneAvatarStatusRateLimit, digitalCloneAvatarVoiceDiscoveryRateLimit, digitalCloneAvatarVoicePreviewRateLimit } from "../middleware/digitalCloneAvatarRateLimit.js";
...
import {
  ...
  deliverDigitalCloneAvatarPreview, deliverDigitalCloneAvatarProviderVoicePreview, deliverDigitalCloneAvatarVideo, discoverDigitalCloneAvatarProviderVoices, discoverDigitalCloneAvatars,
...
router.get("/avatar", getDigitalCloneAvatar);
router.post("/avatar/consent", acceptDigitalCloneAvatarConsent);
...
router.get("/avatar/provider-voices/:voiceId/preview", requireDigitalCloneAvatarConsent, digitalCloneAvatarVoicePreviewRateLimit, deliverDigitalCloneAvatarProviderVoicePreview);
