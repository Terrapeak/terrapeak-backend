export default class BaseAvatarProvider {
  ...
  async listVoices() { throw new Error("listVoices must be implemented by an avatar provider."); }
  async getVoice() { throw new Error("getVoice must be implemented by an avatar provider."); }
